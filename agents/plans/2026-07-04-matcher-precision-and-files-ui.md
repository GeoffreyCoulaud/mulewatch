...
Executes `agents/specs/2026-07-04-matcher-precision-and-files-ui.md`.
...
- Do **not** edit dated historical docs (`agents/specs/`, `agents/plans/`,
  `agents/handoffs/` other than this pair) — they record what was true then.
