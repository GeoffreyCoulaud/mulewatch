...
`agents/reference/2026-06-17-amuled-completion-behavior.md` (`737d851`) :
...
- **Docker Desktop (`Context: desktop-linux`) refuse l'accès au socket aux conteneurs non-root** →
  ...
  [`agents/reference/2026-06-17-docker-desktop-rootless-socket.md`](../reference/2026-06-17-docker-desktop-rootless-socket.md).
