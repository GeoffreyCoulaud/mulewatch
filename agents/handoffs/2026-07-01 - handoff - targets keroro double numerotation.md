...
> Branche `feat/targets-keroro-dual-numbering`. Spec `agents/specs/2026-06-30-targets-keroro-dual-numbering.md`,
> plan `agents/plans/2026-06-30-targets-keroro-dual-numbering.md`. Revue finale de branche : **APPROVE / merge-ready**.
