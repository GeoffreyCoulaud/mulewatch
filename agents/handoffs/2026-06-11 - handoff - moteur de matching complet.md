...
- **Handoffs** (dont le brief de cadrage de tout début) : `agents/handoffs/` — fichiers `<date ISO> - handoff - <contexte>.md` (le cadrage initial : `2026-06-10 - handoff - knowledge brief.md` ; ce document : `2026-06-11 - handoff - moteur de matching complet.md`).
