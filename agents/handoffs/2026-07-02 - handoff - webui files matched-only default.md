...
> Spec `agents/specs/2026-07-02-webui-files-matched-default.md`, plan
> `agents/plans/2026-07-02-webui-files-matched-default.md`. TDD strict, exécution **subagent-driven**
