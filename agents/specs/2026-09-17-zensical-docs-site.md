...
4. Update every reference to a moved path. Measured blast radius outside the archives:
   ...
   mentions of the form `agents/specs/...` are rewritten mechanically.
...
- **Cross-links from operator pages into `agents/reference/` and `agents/specs/`**: those targets leave
