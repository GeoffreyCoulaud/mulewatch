...
Spec: `agents/specs/2026-07-15-files-explorer-sort-search-filter.md`.
Plan: `agents/plans/2026-07-15-files-explorer-sort-search-filter.md`.

This is the second of two chantiers that hardened the catalog before sharing the project with
other lost-media researchers. The first (`agents/handoffs/2026-07-15 - handoff - unidentified
