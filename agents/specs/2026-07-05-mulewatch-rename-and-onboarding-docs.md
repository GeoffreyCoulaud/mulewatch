...
- **Living docs only**: README, runbooks, `docs/README.md`, `docs/testing-guide.md`,
  `docs/legal-and-privacy.md`, CLAUDE.md. Dated historical docs (`agents/handoffs/`,
  `agents/specs/`, `agents/plans/`, `agents/reference/`) keep the old name: they record history.
