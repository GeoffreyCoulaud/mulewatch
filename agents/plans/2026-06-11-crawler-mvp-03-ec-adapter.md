...
agents/reference/2026-06-11-ec-field-richness.md         # Create (livrable 5)
...
```python
"""Constantes du protocole EC, transcrites de agents/reference/ec-protocol.md §7.
...
```python
"""Codec EC PUR et SYNCHRONE : bytes ↔ arbre de tags (cf. agents/reference/ec-protocol.md §1-§3).
...
**Files:**
- Create: `agents/reference/2026-06-11-ec-field-richness.md`

- [ ] **Step 1: Écrire le rapport**

`agents/reference/2026-06-11-ec-field-richness.md` (fence externe à 4 backticks : le document contient lui-même un bloc ```bash) :
````markdown
...
> de recherche. Source : `agents/reference/ec-protocol.md` §5 (vérifié sur les sources
...
```bash
git add "agents/reference/2026-06-11-ec-field-richness.md"
