...
async def _monitor(deps: DownloadDeps, states: dict[str, DownloadState]) -> None:
    ...
    agents/reference/2026-06-17-amuled-completion-behavior.md) : elle vient des fichiers partagés
...
**Files:**
- Modify: `agents/reference/2026-06-17-amuled-completion-behavior.md`
