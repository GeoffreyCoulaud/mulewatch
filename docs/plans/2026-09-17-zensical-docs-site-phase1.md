...
Spec: `docs/specs/2026-09-17-zensical-docs-site.md` (moves to `agents/specs/` in step 1).
...
```bash
mkdir -p agents
git mv docs/specs docs/plans docs/handoffs docs/reference agents/
```

This plan file and the spec move with it (they are in `docs/plans/` and `docs/specs/` at the time of
the move).
...
mentions of the form `docs/specs/...`, `docs/handoffs/...`, `docs/reference/...`, `docs/plans/...`
