...
- `agents/specs/2026-06-10-crawler-mvp-design.md` §3 — révision de l'invariant « aucune variable
  d'environnement ».
- `agents/specs/2026-06-20-deploiement-exemples-design.md` — mise à jour vers la structure `include:`.
