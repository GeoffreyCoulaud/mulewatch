...
`agents/specs/2026-07-10-git-driven-versioning.md` (Status: APPROVED). Implementing it is the
suggested next step.
...
Implement the approved versioning spec (`agents/specs/2026-07-10-git-driven-versioning.md`):
